...
void main()
{
    ...
    for (int i = 0; i < LightCount; i++) {
        ...
        if(light.ShadowIndex >= 0){
            ...
            vec4 DepthSM = texture(ShadowMapTexture[light.ShadowIndex], PosSM.xy);
        ...
        SpecularComponent += SpecularColor  * Color * pow( max(0, dot(N,H)), SpecularExp);
